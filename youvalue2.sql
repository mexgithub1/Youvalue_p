...
CREATE TABLE `depressed` (
  ...
  `priority` enum('High','Medium') NOT NULL DEFAULT 'High',
...
INSERT INTO `depressed` (`id`, `fullname`, `email`, `phone_number`, `age`, `gender`, `date_created`, `priority`, `score`, `status`) VALUES
(1, 'juan cruz', 'godegkola@gmail.com', '09999999', '26', 'Male', '2025-04-02 16:47:34', 'High', 0, 'Pending'),
(2, 'juan cruz2', 'godegkola@gmail.com', '09999999', '26', 'Male', '2025-04-02 16:47:34', 'High', 0, 'Pending'),
(3, 'Lovely Villacorte', 'sorar384@gmail.com', '09999999', '23', 'Male', '2025-04-11 22:49:32', 'High', 0, 'Completed');
...
CREATE TABLE `questionnaires` (
  ...
  `category` enum('normal','anxiety','depression') DEFAULT 'normal'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `questionnaires` (`id`, `questions`, `choice1`, `choice2`, `choice3`, `choice4`, `answers`, `category`) VALUES
(21, 'Have you felt sad or down most of the time in the past few days?', 'Not at all', 'Occasionally', 'Sometimes', 'Almost every day', 'Almost every day', 'depression'),
(22, 'Have you had trouble sleeping or sleeping too much recently?', 'Almost every night', 'Some nights', 'Not at all', 'Rarely', 'Nearly every day', 'normal'),
(23, 'Have you had difficulty enjoying things you used to find pleasurable?', 'Not at all', 'Some days', 'Rarely', 'Almost every day', 'Almost every day', 'normal'),
(24, 'Have you been feeling nervous, anxious, or on edge?', 'Rarely', 'Occasionally', 'Never', 'All the times', 'All the times', 'anxiety'),
(25, 'Have you been feeling tired or low on energy even after resting?', 'Not at all', 'Almost everyday', 'Sometimes', 'Rarely', 'Almost everyday', 'normal'),
(26, 'Have you found it difficult to stay focused on what you\'re doing, even simple tasks?', 'Most of the times', 'Not at all', 'Rarely', 'From time to time', 'Most of the times', 'normal'),
(27, 'Have you been feeling irritable or easily frustrated?', 'A few times', 'Rarely', 'Almost everyday', 'Never', 'Almost everyday', 'normal'),
(28, 'Have you been withdrawing from social activities or avoiding people?', 'Sometimes', 'Most of the times', 'Rarely', 'Not at all', 'Most of the times', 'normal'),
(29, 'Have you experienced changes in appetite or eating habits?', 'Sometimes', 'Never', 'Occasionally', 'Almost every day', 'Almost every day', 'normal'),
(30, 'Have you felt overwhelmed by your responsibilities or daily tasks?', 'Everytime', 'A few times', 'Not at all', 'Occasionally', 'Everytime', 'normal'),
(46, 'How often do you feel overwhelmed by daily tasks?', 'Never', 'Sometimes', 'Often', 'Always', 'Never', 'normal'),
(47, 'How would you rate your sleep quality?', 'Excellent', 'Good', 'Fair', 'Poor', 'Excellent', 'normal'),
(48, 'How often do you feel energetic throughout the day?', 'Always', 'Often', 'Sometimes', 'Never', 'Always', 'normal'),
(49, 'How would you describe your social interactions?', 'Very Active', 'Moderately Active', 'Somewhat Limited', 'Very Limited', 'Very Active', 'normal'),
(50, 'How do you handle stress?', 'Very Well', 'Well', 'With Difficulty', 'Poorly', 'Very Well', 'normal'),
(51, 'Would you rather have a cup water half empty or half full?', 'half empty', 'half full', 'both', 'i dont wanna answer', 'i dont wanna answer', 'normal');

-- --------------------------------------------------------

--
-- Table structure for table `questionnaires_anxiety_2`
--
...
--
-- Dumping data for table `questionnaires_anxiety_2`
--

INSERT INTO `questionnaires_anxiety_2` (`id`, `questions`, `choice1`, `choice2`, `choice3`, `choice4`, `answers`, `date_created`) VALUES
(1, 'How often do you experience physical symptoms of anxiety?', 'Never', 'Sometimes', 'Often', 'Very Often', 'Never', '2025-05-13 20:08:48'),
(2, 'When anxious, what coping strategies do you use?', 'Multiple strategies', 'Few strategies', 'One strategy', 'No strategies', 'Multiple strategies', '2025-05-13 20:08:48'),
(3, 'How does anxiety affect your daily activities?', 'No effect', 'Minor effect', 'Moderate effect', 'Severe effect', 'No effect', '2025-05-13 20:08:48'),
(4, 'Do you avoid situations due to anxiety?', 'Never', 'Rarely', 'Sometimes', 'Often', 'Never', '2025-05-13 20:08:48'),
(5, 'How well can you identify anxiety triggers?', 'Very well', 'Somewhat', 'Not very well', 'Not at all', 'Very well', '2025-05-13 20:08:48');

-- --------------------------------------------------------

--
-- Table structure for table `questionnaires_depression_2`
--
...
--
-- Dumping data for table `questionnaires_depression_2`
--

INSERT INTO `questionnaires_depression_2` (`id`, `questions`, `choice1`, `choice2`, `choice3`, `choice4`, `answers`, `date_created`) VALUES
(1, 'How is your appetite compared to usual?', 'Normal', 'Slightly changed', 'Moderately changed', 'Severely changed', 'Normal', '2025-05-13 20:08:48'),
(2, 'How often do you feel hopeful about the future?', 'Always', 'Often', 'Sometimes', 'Rarely', 'Always', '2025-05-13 20:08:48'),
(3, 'How is your concentration level?', 'Excellent', 'Good', 'Fair', 'Poor', 'Excellent', '2025-05-13 20:08:48'),
(4, 'How often do you engage in activities you used to enjoy?', 'Frequently', 'Sometimes', 'Rarely', 'Never', 'Frequently', '2025-05-13 20:08:48'),
(5, 'How would you rate your energy levels?', 'High', 'Moderate', 'Low', 'Very Low', 'High', '2025-05-13 20:08:48');

-- --------------------------------------------------------

--
-- Table structure for table `questionnaires_normal_2`
--
...
--
-- Dumping data for table `questionnaires_normal_2`
--

INSERT INTO `questionnaires_normal_2` (`id`, `questions`, `choice1`, `choice2`, `choice3`, `choice4`, `answers`, `date_created`) VALUES
(1, 'How satisfied are you with your daily routine?', 'Very Satisfied', 'Satisfied', 'Somewhat Satisfied', 'Not Satisfied', 'Very Satisfied', '2025-05-13 20:08:47'),
(2, 'How often do you engage in activities you enjoy?', 'Daily', 'Few times a week', 'Once a week', 'Rarely', 'Daily', '2025-05-13 20:08:47'),
(3, 'Rate your ability to maintain work-life balance:', 'Excellent', 'Good', 'Fair', 'Poor', 'Excellent', '2025-05-13 20:08:47'),
(4, 'How often do you practice self-care?', 'Regularly', 'Sometimes', 'Rarely', 'Never', 'Regularly', '2025-05-13 20:08:47'),
(5, 'How would you rate your current stress management?', 'Very Effective', 'Effective', 'Somewhat Effective', 'Not Effective', 'Very Effective', '2025-05-13 20:08:47');
...
(1, 'Book about happiness', 'Chapter 1&5-Firesafezone.docx', 'Anxiety', '2025-04-02 16:35:33'),
(2, 'What to do when depressed', 'IM-IPT.pdf', 'Depressed', '2025-04-02 16:35:49'),
(4, 'Foods to help you fight anxiety', 'TWO HEARTS.pdf', 'Anxiety', '2025-04-11 22:51:39');
...
(12, '9516736969', 111, 10, '2025-05-13 07:34:26'),
(13, '1943119214', 111, 0, '2025-05-13 07:34:41'),
(14, '1258010854', 105, 50, '2025-05-13 08:15:23'),
(15, '5774539608', 113, 0, '2025-05-13 08:23:35'),
(16, '1308766597', 110, 0, '2025-05-13 09:39:16'),
(17, '1900979987', 110, 0, '2025-05-13 09:39:28');
...
(178, '9516736969', 111, 27, 'Rarely'),
(179, '9516736969', 111, 22, 'Almost every night'),
(180, '9516736969', 111, 47, 'Good'),
(181, '9516736969', 111, 48, 'Sometimes'),
(182, '9516736969', 111, 25, 'Sometimes'),
(183, '9516736969', 111, 29, 'Occasionally'),
(184, '9516736969', 111, 21, 'Not at all'),
(185, '9516736969', 111, 50, 'Very Well'),
(186, '9516736969', 111, 24, 'Occasionally'),
(187, '9516736969', 111, 49, 'Moderately Active'),
(188, '1943119214', 111, 3, 'Good'),
(189, '1943119214', 111, 1, 'Somewhat Satisfied'),
(190, '1943119214', 111, 4, 'Sometimes'),
(191, '1943119214', 111, 2, 'Few times a week'),
(192, '1943119214', 111, 5, 'Somewhat Effective'),
(193, '1258010854', 105, 28, 'Most of the times'),
(194, '1258010854', 105, 21, 'Almost every day'),
(195, '1258010854', 105, 29, 'Almost every day'),
(196, '1258010854', 105, 27, 'Almost everyday'),
(197, '1258010854', 105, 46, 'Always'),
(198, '1258010854', 105, 51, 'half full'),
(199, '1258010854', 105, 25, 'Almost everyday'),
(200, '1258010854', 105, 47, 'Poor'),
(201, '1258010854', 105, 50, 'Poorly'),
(202, '1258010854', 105, 48, 'Never'),
(203, '5774539608', 113, 48, 'Sometimes'),
(204, '5774539608', 113, 23, 'Rarely'),
(205, '5774539608', 113, 46, 'Sometimes'),
(206, '5774539608', 113, 21, 'Not at all'),
(207, '5774539608', 113, 29, 'Never'),
(208, '5774539608', 113, 25, 'Rarely'),
(209, '5774539608', 113, 47, 'Good'),
(210, '5774539608', 113, 28, 'Rarely'),
(211, '5774539608', 113, 26, 'From time to time'),
(212, '5774539608', 113, 49, 'Somewhat Limited');
...
(1, 'Barbecued-snags.jpg', 'godeg test', 'kola', '', '', '', '', 'admin@admin.com', '$2y$10$PI0nCdoRms.MjY7epPZVqu67pbH0cyACqwnl3ZGx9qox0R23no0gG', 'admin', '0', '', 22198, 2, '2025-05-13', 0),
(105, 'blank_profile.png', 'Max', 'Marquez', 'ttest', '9878676675', '33', 'Male', 'Maxmarquez123@aup.edu.ph', '$2y$10$IeJ4y2.eNwa4p3UMZu3blOOodVKFxz2zeHfrBv0goCavl.jFm4mzW', '111', '', '', 0, 0, '2025-05-13', 1),
(106, 'blank_profile.png', 'sorar', 'sorar', 'sorar', '', '', '', 'sorar384@gmail.com', '$2y$10$Y8h1jxlcFHSxFtyjvXB5z.qtIhxWAYqdb5zfHQsiNYAgRci7tpkCu', '123', '', '', 0, 0, '2025-05-13', 0),
(108, 'blank_profile.png', 'Guidance', 'Faculty', '', '', '', '', 'faculty2@email.com', '$2y$10$y86IYywbdcKhqW7q0SLLV.rNavSZMgN/.defMImpPpZYEYfJk/TKq', '123', '', '', 0, 1, '2025-05-13', 0),
(110, '', 'test', 'sdfdsf', 'sdfsdf', '09999999', '34', 'Male', 'test@gmail.com', '$2y$10$N3gMznlDluBoCQnGHX.xIepemS8AQwAkEg4Gwg1V26NMYrP.xDWa6', '123', '', '', 0, 0, '2025-05-13', 2),
(111, '', 'Max', 'Marquez', 'G.', '09162432961', '35', 'Male', '2040359@aup.edu.ph', '$2y$10$0Su/aGlTmz1XRPSwg2L9K.QTx6DvQe9NEczG1szeinfCMF0bULp/m', 'youvalue1', '', '', 0, 0, '2025-05-13', 2),
(112, '', 'First', 'Test', 'T', '09321', '18', 'Male', 'testing1@email.com', '$2y$10$pwoJPZ2BrXJnKPAcYSEGR.uhIiuL0wzLDxu043/5dD83YSHIMPbL6', '123', '', '', 0, 0, '2025-05-13', 0),
(113, '', 'Second', 'Testing', 'T', '123', '19', 'Male', 'testing2@email.com', '$2y$10$5h7gPkVtiaS93huGSDy.gO/29WZFCCc.NyjJpOf1oWLdoxETIcs9O', '123', '', '', 0, 0, '2025-05-13', 1);

-- --------------------------------------------------------

--
-- Table structure for table `user_assessment_history`
--
...
--
-- Dumping data for table `user_assessment_history`
--

INSERT INTO `user_assessment_history` (`id`, `users_id`, `last_category`, `assessment_date`) VALUES
(1, 111, 'normal', '2025-05-13'),
(2, 111, 'normal', '2025-05-13'),
(3, 105, 'anxiety', '2025-05-13'),
(4, 113, 'normal', '2025-05-13'),
(5, 110, 'normal', '2025-05-13'),
(6, 110, 'normal', '2025-05-13');
...
--
-- Indexes for table `questionnaires_anxiety_2`
--
ALTER TABLE `questionnaires_anxiety_2`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `questionnaires_depression_2`
--
ALTER TABLE `questionnaires_depression_2`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `questionnaires_normal_2`
--
ALTER TABLE `questionnaires_normal_2`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `user_assessment_history`
--
ALTER TABLE `user_assessment_history`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `questionnaires_anxiety_2`
--
ALTER TABLE `questionnaires_anxiety_2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `questionnaires_depression_2`
--
ALTER TABLE `questionnaires_depression_2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `questionnaires_normal_2`
--
ALTER TABLE `questionnaires_normal_2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `user_assessment_history`
--
ALTER TABLE `user_assessment_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Constraints for table `user_assessment_history`
--
ALTER TABLE `user_assessment_history`
  ADD CONSTRAINT `user_assessment_history_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`);
COMMIT;
